...
export default function RegisterScreen({ navigation }: Props) {
  ...
  return (
    <Screen scroll>
      ...
      <Input label="Referral code (optional)" value={form.referral_code} onChangeText={(v) => setForm({ ...form, referral_code: v })} />
      <Input label="Invite code (optional)" value={form.invite_code} onChangeText={(v) => setForm({ ...form, invite_code: v })} hint="Required only when pilot mode is enabled" />
